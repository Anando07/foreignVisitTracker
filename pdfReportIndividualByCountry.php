...
$x = ($pageWidth - $logoWidth) / 2; // horizontal center
$y = 10; // top margin
...
$sql = "SELECT * FROM ForeignVisit 
        WHERE DestinationCountry = '$countryReq' 
...
$pdf->Cell(0,10,"Record of Foreign Visits to $countryReq from $startDate to $endDate",1,1,'C');
