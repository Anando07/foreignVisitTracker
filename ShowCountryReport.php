...
<h2 align="center"> Time based Report (Country-wise) </h2> 
...
$countryReq = $_POST['countryReq']; 
$startDate = $_POST['FromDate'];
$endDate = $_POST['ToDate'];

if($countryReq == ""){
	die("<br><br><center> Sorry. Country field cannot be left empty. <center><br><br>");
}
...
$countryReqEncoded = urlencode($countryReq);
$countryReqDecoded = urldecode($countryReq);
echo '<a href=pdfReportIndividualByCountry.php?countryReq='.$countryReqEncoded.'&FromDate='.$startDate.'&ToDate='.$endDate.' target="_blank"> <p style="text-align:center"> Download Report </p></a>'; 
//echo '<a href = uploads.html?id='.$nameReqEncoded.'> Link </a>';

$sql1 = "SELECT * from ForeignVisit WHERE DestinationCountry = '" . $countryReq . "' ORDER BY StartDate desc"; 
...
if ($result->num_rows > 0) {
    ...
    //echo "<br>";
    echo "<center> <b> <u> Country Search Result (" . $countryReq . ")" . "</u> </b> </center> <br>";
