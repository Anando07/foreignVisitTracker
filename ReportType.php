...
<h4 align="right"> <a class="active" href = "ActionType.php"> Home</a> &nbsp; &nbsp; &nbsp; <a href = "Logout.php">Sign Out</a> </h4> 
</head>
<body style="background-color:powderblue;">
<br><br><br>
<center> 
<button onclick=" window.open('./ReportIndividualByID.php', '_blank'); return false;">By Service ID</button>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<button onclick=" window.open('./ReportIndividualByName.php', '_blank'); return false;">By Name</button> 
</center>
