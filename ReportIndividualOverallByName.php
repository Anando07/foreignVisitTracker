...
function validateForm() { 
  let x = document.forms["frm2"]["nameOverallReq"].value;
  if (x == "") {
...
<body>
<br> <br> <br> <br>
<form id="frm2" method="POST" action="ShowNameOverallReport.php" onsubmit="return validateForm()">
<div class="autocomplete-container">
  <center>Name: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="nameOverallReq" id="nameOverallReq" size="50" maxlength="50"> </center>
</div>
  <br>
...
<center><input type="submit" value="View Report"> </center>
  ...
  <script type="text/javascript" src="frontend-script-overall.js"></script>
