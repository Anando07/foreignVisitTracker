...
function validateForm() {
  let x = document.forms["frm2"]["idOverallReq"].value;
  if (x == "") {
...
<body>
<br> <br> <br> <br>
<form id="frm2" method="POST" action="ShowIDOverallReport.php" onsubmit="return validateForm()">
  <center>Service ID: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="number" name="idOverallReq" size="50" maxlength="50"> </center><br> </center><br>
