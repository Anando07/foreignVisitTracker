...
<form id="frm1" method="POST" action="action_page.php" enctype="multipart/form-data" onsubmit="return validateForm()"> 
  ...
  <select name="cadreName" id="cadreName" text-align:center>   
    <option value="" ></option>  
  ...
  <select name="officeName" id="officeName" onchange="changedesig(this.value);" text-align:center>   
  	<option value="" ></option>  
...
function myFunction() {
  ...
  let x3 = document.forms["frm1"]["officeName"].value; 
  if (x3 == "") {
