...
<body>
<br> <br> <br> <br>
<form id="frm2" method="POST" action="PNV_ShowNameReport.php" onsubmit="return validateForm()">
  <center>Name: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="nameReq" size="50" maxlength="50"> </center><br>
<br>
