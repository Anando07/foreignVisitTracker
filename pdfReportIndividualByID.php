...
$sql = "SELECT * from ForeignVisit WHERE ServiceID = " . $idReq . " ORDER BY StartDate desc";
...
$pdf->Ln();	
//$pdf->Cell(0,10,'Foreign Visit Record by Name',0.0,0.0,'C');
$pdf->Cell(0,10,'Foreign Visit Record of Service ID: '.$idReq." from ". $startDate." to ".$endDate,1.0,0.0,'C');
$pdf->SetFont('Arial','',8);
$pdf->Ln();	
