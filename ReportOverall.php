...
<br><br><br>
<center> 
<button onclick=" window.open('./ReportIndividualOverallByID.php', '_blank'); return false;">By Service ID</button>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<button onclick=" window.open('./ReportIndividualOverallByName.php', '_blank'); return false;">By Name</button> 
