...
function validateForm() { 
  let x = document.forms["frm2"]["countryReq"].value;
  if (x == "") {
...
<br> <br> 
<form id="frm2" method="POST" action="ShowCountryReport.php" onsubmit="return validateForm()"> 
  <center>Country: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   <select name="countryReq" onchange='CheckPlace(this.value); ' text-align:center>  
