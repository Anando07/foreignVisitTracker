...
<br><br><br>
<center> 
<button onclick=" window.open('./PNV_ReportIndividualByID.php', '_blank'); return false;">By Service ID</button>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<button onclick=" window.open('./PNV_ReportIndividualByName.php', '_blank'); return false;">By Name</button> 
