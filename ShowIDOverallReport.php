...
$idOverallReq = $_POST['idOverallReq']; 
...
$idOverallReqEncoded = urlencode($idOverallReq);
$idOverallReqDecoded = urldecode($idOverallReq);
echo '<a href=pdfReportIndividualOverallByID.php?idOverallReq='.$idOverallReqEncoded.' target="_blank"> <p style="text-align:center"> Download Report </p></a>'; 

$sql1 = "SELECT * from ForeignVisit WHERE ServiceID = " . $idOverallReq . " ORDER BY StartDate desc";
...
if ($result->num_rows > 0) {
    ...
    //echo "<br> <br><br><br>";
    echo "<center> <b> <u> Service ID Search Result (". $idOverallReq . ")</u> </b> </center> <br>"; 
    echo "<center> Total matches found: <b> ". $count . "</b> </center> <br>"; 
