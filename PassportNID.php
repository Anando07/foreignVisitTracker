...
<br><br><br>
<center> 
<button onclick=" window.open('./PN_NewEntry.php', '_blank'); return false;">New Entry</button>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<button onclick=" window.open('./PN_ReportType.php', '_blank'); return false;">View & Edit</button> 
