...
<h2 align="center"> <font color='red'> Unreported Cases </font> </h2>
...
echo '<a href=pdfUnreportedCases.php target="_blank"> <p style="text-align:center"> Download Report </p></a>'; 

//$sql1 = "SELECT * from ForeignVisit WHERE Name LIKE '" ."%" . $nameOverallReq . "%" . "' ORDER BY StartDate desc";
//$sql1 = "SELECT * from ForeignVisit WHERE ActualArrival = 0000-00-00 OR ActualDeparture = 0000-00-00 ORDER BY StartDate desc";
//$sql1 = "SELECT * from ForeignVisit WHERE ActualArrival = 0000-00-00 OR ActualDeparture = 0000-00-00 ORDER BY EndDate ASC"; 
$sql1 = "SELECT * from ForeignVisit WHERE ActualArrival = 0000-00-00 AND EndDate < CURDATE() ORDER BY EndDate ASC"; 
...
if ($result->num_rows > 0) {
    ...
    //echo "<br>";
    echo "<center> <b> <font color='red'> Unreported Cases" . " </font> </b> </center> <br>";
    echo "<center> Number of <font color='red'> unreported cases </font> found: <b> <font color='red'>". $count . "</font> </b> </center> <br>";
